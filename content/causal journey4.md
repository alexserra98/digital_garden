...
The first criterion is the **Back-Door** and is discussed [[Causal journey4 | here]]. (note to add controlling back-door path is used to change $P(y|\hat{x})$ to $P(y|x)$)
...
$$P(y \mid do(z), w) = P(y \mid w) \quad \text{if} \quad Y \perp\!\!\!\perp_{G_{\overline{Z}(W)}} Z \mid W$$
